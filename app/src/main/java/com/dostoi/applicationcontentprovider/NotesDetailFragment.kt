...
import com.dostoi.applicationcontentprovider.database.NotesDatabaseHelper.Companion.DESCRIPTION_NOTES
import com.dostoi.applicationcontentprovider.database.NotesDatabaseHelper.Companion.TITLE_NOTES
import com.dostoi.applicationcontentprovider.database.NotesProvider.Companion.URI_NOTES
import java.net.URI
...
class NotesDetailFragment: DialogFragment(), DialogInterface.OnClickListener {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        noteEditDescription = view?.findViewById(R.id.note_edt_descricao) as EditText
